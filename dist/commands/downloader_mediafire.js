...
exports.default = {
    ...
    handler(bot, args, context) {
        return __awaiter(this, void 0, void 0, function* () {
            const url = args[0];
            if (!(url === null || url === void 0 ? void 0 : url.includes('mediafire.com')))
                return bot.sendMessage(context.chat, '⚠️ Kasih link Mediafire yang valid!');
            try {
                const result = yield (0, btchDownloader_1.downloadMediafire)(url);
                ...
                yield bot.sendDocument(context.chat, buffer, filename, `📁 ${filename}`);
            }
            catch (error) {
