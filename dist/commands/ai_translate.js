...
exports.default = {
    ...
    handler(bot, args, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { translate } = yield Promise.resolve().then(() => __importStar(require('@vitalets/google-translate-api')));
                const res = yield translate(text, { to: targetLang });
                yield bot.sendMessage(context.chat, `🌐 *${targetLang.toUpperCase()}*\n${res.text}`);
            }
            catch (error) {
